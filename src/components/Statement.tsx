...
const COPY = {
  es: {
    ...
    trail: "cara a cara, sin jerarquías, con el mar de fondo. Por eso, desde 2019, los meetups de PlayasOnTech reúnen cada dos meses a quienes construyen tecnología en el Pacífico mexicano.",
  },
  en: {
    lead: "We believe the best ideas are born when the developer community gets together —",
    trail: "face to face, no hierarchies, with the sea in the background. That's why, since 2019, PlayasOnTech meetups gather those building tech in the Mexican Pacific every two months.",
  },
} as const;
