...
const COPY = {
  es: {
    ...
    intro:
      "Playas on Tech es una comunidad independiente, organizada por voluntarios en Manzanillo, Colima. Todo lo que hacemos es gratuito y abierto: los eventos, el conocimiento y los materiales. Nos sostenemos con donaciones y patrocinios, no con fines de lucro.",
  ...
  en: {
    ...
    h2: "Open, non-profit.",
    intro:
      "Playas on Tech is an independent community, organized by volunteers in Manzanillo, Colima. Everything we do is free and open: events, knowledge and materials. We sustain ourselves with donations and sponsorships, never for profit.",
    termsPrefix: "See the",
