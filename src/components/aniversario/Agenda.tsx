...
const schedule: ScheduleItem[] = [
  ...
  { time: "12:40 – 1:15pm", label: "Panel: Affadir Camal & Iván Alva", talk: "Hacking Trust: Seguridad que todos deberíamos entender", photos: [{ src: "/assets/speakers/allfadir.jpg" }, { src: "/assets/speakers/ivanalva.jpg" }], type: "panel" as const },
  { time: "1:15 – 2:45pm", label: "Comida", talk: "", photos: [], type: "comida" as const },
